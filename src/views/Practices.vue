  ...
  <div class="container mx-auto px-4">
    <div class="flex flex-wrap px-4">
      <div class="flex flex-col min-w-0 break-words bg-white drop-shadow-xl w-full mb-8 shadow-lg rounded-3xl">
        ...
        <div class="md:px-14 grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-4 flex-auto">
          <div v-for="(img, index) in paginatedOrders" :key="index" @click="() => showImg(((currentPage - 1) * perPage) + index)" data-aos="zoom-in" class="w-60 h-48 mb-10 mx-auto shadow-md hover:shadow-lg cursor-pointer rounded-3xl border-color-card flex justify-center items-center">

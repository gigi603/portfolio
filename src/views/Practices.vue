<template>
  <div class="container mx-auto px-4">
    <div class="flex flex-wrap px-4">
      <div class="relative flex flex-col min-w-0 break-words bg-white drop-shadow-xl w-full mb-8 shadow-lg rounded-3xl">
        <div class="py-10" style="padding-left: 4.5rem;"><h2 class="font-bold text-2xl">PRACTICES</h2></div>
        <div class="px-14 grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-4 flex-auto">

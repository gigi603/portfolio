<template>
  <div class="container mx-auto px-4">
    <div class="flex flex-wrap px-4">
      <form ref="form" @submit.prevent="checkForm" id="contact-form" class="relative flex flex-col my-20 min-w-0 break-words bg-white w-full shadow-lg rounded-3xl">
        <div class="pt-10"><h2 class="font-bold text-center text-3xl">Me contacter</h2></div>
